...
% ---------------------------------------
    ...
    function allign
        %allign allignes content in word
        
        hdlActiveX.Selection.ParagraphFormat.Alignment = 'wdAlignParagraphCenter';
...
% ---------------------------------------
    ...
    function insertImage(imgName)
        %insertImage add image to the document
        
        % add picture
        hdlActiveX.Selection.InlineShapes.AddPicture(imgName);  % absolute path to the image
    end
% ---------------------------------------
